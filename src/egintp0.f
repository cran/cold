      subroutine gintp0(grad,gvar,bt2,beta2,omega,npar,link,
     *maxy,x2,y2,theta2,work2,n,li,ls,epsabs,epsrel,key,limit)
      implicit double precision (a-h,o-z)    
      External fpb0, fpvar0
     ...
     *work2(n),bt2(npar-1),grad(npar-1),
   ...
   30 continue 
      ...
      do 60 iaux=1,(npar-1)
      CALL dqager(fpb0,a,b,epsabs,epsrel,key,limit,res1,abserr,
     *neval,ier,alist,blist,rlist,elist,iord,last,iaux)
      grad(iaux)=res1
   60 continue

      CALL dqager(fpvar0,a,b,epsabs,epsrel,key,limit,res2,abserr,
